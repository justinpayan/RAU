...
if __name__ == "__main__":
    ...
    fname = "stat_dict_iclr_%d_%d_origvsalt.pkl" % (year, seed)
    ...
    st = time.time()
    alt_fractional_alloc_max_min = solve_max_min_alt(means, covs, loads, std_devs, integer=False)
    ...
    np.save(os.path.join(data_dir, "outputs", "alt_fractional_max_min_alloc_iclr_%d_%d.npy" % (year, seed)), alt_fractional_alloc_max_min)
