...
def query_model(dset_name, obj, lamb, seed, data_dir, query_model_type):
    ...
    if query_model_type == "greedymax":
    ...
    elif query_model_type == "randomsample":
        query_model = RandomSampleQueryModel(tpms, dset_name, solver, covs, loads)
        ...
        query_model = SuperStarGreedyMaxQueryModel(tpms, covs, loads, solver, dset_name, data_dir, k=100, b=4, d=10, beam_sz=50, max_iters=3)
